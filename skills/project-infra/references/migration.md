...
| A configuration file seeded only so the CLI found one at an expected name, including a bridge re-exporting the real configuration | Nothing. The file the bridge pointed at stays                                                                                                                                                                |
